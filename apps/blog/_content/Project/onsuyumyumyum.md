...
생각보다 다수의 사용자가 유입되어 서비스를 사용하고 있기에 지속적인 서비스가 되기 위해서 SSR을 고려해야 한다고 생각합나다.
...
Hotjar를 살펴보면 모바일 사용자가 압도적으로 더 많은 모습을 볼 수 있습니다.
...
온수냠냠냠에서는 식당의 전체 메뉴와 해당 가격 및 이미지를 볼 수 있고 kakao map api를 이용한 식당의 위치를 볼 수 있습니다.
...
후기페이지를 구현하기 위해 마크다운을 컴파일하였고 `remark`를 사용하였습니다.
